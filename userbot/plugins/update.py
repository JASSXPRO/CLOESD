    ...
    if HEROKU_API_KEY is not None:
        ...
        if HEROKU_APP_NAME is None:
            await event.edit(
                ...
                " to be able to deploy your BLAC 2.0_userbot.**"
            )
            repo.__del__()
            return
        ...
        if heroku_app is None:
            await event.edit(
                f"{txt}\n" "**Invalid Heroku credentials for updating BLAC 2.0_userẞøt.**"
            )
            return repo.__del__()
        ups_rem.fetch(ac_br)
        ...
        if build.status == "failed":
            ...
            await event.edit(
                "Updated your __BLAC 2.0_USERBOT__ successfully sir!!!\n\nNow type .ping after 25 mins to check if I'm on🚶😏"
            )
    else:
...
async def upstream(event):
    ...
    if conf == "deploy":
        await event.edit(
            "Updated your BLAC 2.0_USERBOT successfully sir!!!\n\nNow type .ping after 25 mins to check if I'm on🚶😏\n\n**NOTE :** This is a powerful update process."
        )
